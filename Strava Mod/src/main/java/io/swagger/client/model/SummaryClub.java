...
public class SummaryClub extends MetaClub {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(profileMedium, coverPhoto, coverPhotoSmall, sportType, activityTypes, city, state, country, _private, memberCount, featured, verified, url, super.hashCode());
  }
