...
public class UpdatableActivity {
  ...
  **/
  ...
  public UpdatableActivity hideFromHome(Boolean hideFromHome) {
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(value = "Deprecated. Prefer to use sport_type. In a request where both type and sport_type are present, this field will be ignored")
  ...
  public UpdatableActivity sportType(SportType sportType) {
