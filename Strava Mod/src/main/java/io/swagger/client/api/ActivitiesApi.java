...
public class ActivitiesApi {
     ...
     */
    public com.squareup.okhttp.Call createActivityCall(String name, String sportType, OffsetDateTime startDateLocal, Integer elapsedTime, String type, String description, Float distance, Integer trainer, Integer commute, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createActivityValidateBeforeCall(String name, String sportType, OffsetDateTime startDateLocal, Integer elapsedTime, String type, String description, Float distance, Integer trainer, Integer commute, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (sportType == null) {
            throw new ApiException("Missing the required parameter 'sportType' when calling createActivity(Async)");
        }
        ...
        com.squareup.okhttp.Call call = createActivityCall(name, sportType, startDateLocal, elapsedTime, type, description, distance, trainer, commute, progressListener, progressRequestListener);
        return call;
     ...
     */
    public DetailedActivity createActivity(String name, String sportType, OffsetDateTime startDateLocal, Integer elapsedTime, String type, String description, Float distance, Integer trainer, Integer commute) throws ApiException {
        ApiResponse<DetailedActivity> resp = createActivityWithHttpInfo(name, sportType, startDateLocal, elapsedTime, type, description, distance, trainer, commute);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DetailedActivity> createActivityWithHttpInfo(String name, String sportType, OffsetDateTime startDateLocal, Integer elapsedTime, String type, String description, Float distance, Integer trainer, Integer commute) throws ApiException {
        com.squareup.okhttp.Call call = createActivityValidateBeforeCall(name, sportType, startDateLocal, elapsedTime, type, description, distance, trainer, commute, null, null);
     ...
     */
    public com.squareup.okhttp.Call createActivityAsync(String name, String sportType, OffsetDateTime startDateLocal, Integer elapsedTime, String type, String description, Float distance, Integer trainer, Integer commute, final ApiCallback<DetailedActivity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createActivityValidateBeforeCall(name, sportType, startDateLocal, elapsedTime, type, description, distance, trainer, commute, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DetailedActivity>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getKudoersByActivityIdCall(Long id, Integer page, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getKudoersByActivityIdValidateBeforeCall(Long id, Integer page, Integer perPage, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<SummaryAthlete> getKudoersByActivityId(Long id, Integer page, Integer perPage) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<SummaryAthlete>> getKudoersByActivityIdWithHttpInfo(Long id, Integer page, Integer perPage) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getKudoersByActivityIdAsync(Long id, Integer page, Integer perPage, final ApiCallback<List<SummaryAthlete>> callback) throws ApiException {
